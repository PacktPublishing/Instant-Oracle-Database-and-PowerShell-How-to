About
=====
This script defines a function to get a DataReader given a connection and a sql select statement. 
It iterates over database records, selecting one at a time, getting record fields and checking for null.
