About
=====
This example illustrates invoking an Oracle procedure that returns multiple REF CURSORS, and loading that data 
into a DataSet; in this example the DataSet is created automatically using table names that match the REF CURSOR parameters.

Before Running
==============
Run the sample package SQL file EMPLOYEE_PACKAGE.pls (located in the root folder of this recipe) in a DBMS tool such as SQL Developer or Toad for Oracle.
